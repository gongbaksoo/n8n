...
- **제외 필터**:
  ...
  - 스크래핑 불가 언론사 제외 (13곳: 뉴시스, 브릿지경제, 헤럴드경제, v.daum.net, 네이트, 아주경제, 파이낸셜뉴스, 게임플, 바이오타임즈, 로이슈, 더스쿠프, 전자신문, SR타임스)
- **중복 제거**: Jaccard 단어 유사도 > 0.3인 기사 클러스터링 (키워드별 그룹화, 키워드당 Top 5)
- **유형 자동 분류**:
...
| 스크래핑 불가 언론사 제외 | ✅ 완료 | 13곳 (뉴시스, 브릿지경제, 헤럴드경제, v.daum.net, 네이트, 아주경제, 파이낸셜뉴스, 게임플, 바이오타임즈, 로이슈, 더스쿠프, 전자신문, SR타임스) |
