...
- **제외 필터**:
  ...
  - 스크래핑 불가 언론사 제외 (뉴시스, 브릿지경제, 헤럴드경제, v.daum.net, 네이트, 아주경제, 파이낸셜뉴스, 게임플, 바이오타임즈, 로이슈, 더스쿠프)
...
| 스크래핑 불가 언론사 제외 | ✅ 완료 | 11곳 (뉴시스, 브릿지경제, 헤럴드경제, v.daum.net, 네이트, 아주경제, 파이낸셜뉴스, 게임플, 바이오타임즈, 로이슈, 더스쿠프) |
